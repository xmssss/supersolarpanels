...
public class TileEntityGenerationMicrochip extends TileEntityBaseGenerationMicrochip {
	...
	public TileEntityGenerationMicrochip() {
		super(1, 300, 1);
		this.inputSlotA = (InvSlotProcessable) new InvSlotProcessableGenerationMicrochip(this, "inputA", 0, 1,
				Recipes.GenerationMicrochip);
		this.inputSlotB = (InvSlotProcessable) new InvSlotProcessableGenerationMicrochip(this, "inputB", 1, 1,
				Recipes.GenerationMicrochip);
		this.inputSlotC = (InvSlotProcessable) new InvSlotProcessableGenerationMicrochip(this, "inputC", 2, 1,
				Recipes.GenerationMicrochip);
		this.inputSlotD = (InvSlotProcessable) new InvSlotProcessableGenerationMicrochip(this, "inputD", 3, 1,
				Recipes.GenerationMicrochip);
		this.inputSlotE = (InvSlotProcessable) new InvSlotProcessableGenerationMicrochip(this, "inputE", 4, 1,
				Recipes.GenerationMicrochip);
	...
	public static void GenerationMicrochip(IRecipeInput container, IRecipeInput fill, IRecipeInput fill1,
			IRecipeInput fill2, IRecipeInput container1, ItemStack output) {
