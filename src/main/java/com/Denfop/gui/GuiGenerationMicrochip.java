...
public class GuiGenerationMicrochip extends GuiIC2 {
  public ContainerBaseGenerationChipMachine<? extends TileEntityGenerationMicrochip> container;
  
  public GuiGenerationMicrochip(ContainerBaseGenerationChipMachine<? extends TileEntityGenerationMicrochip> container1) {
  ...
  protected void drawGuiContainerBackgroundLayer(float f, int x, int y) {
    ...
    int chargeLevel = (int)(14.0F * ((TileEntityGenerationMicrochip)this.container.base).getChargeLevel());
    int progress = (int)(24.0F * ((TileEntityGenerationMicrochip)this.container.base).getProgress());
    if (chargeLevel > 0)
