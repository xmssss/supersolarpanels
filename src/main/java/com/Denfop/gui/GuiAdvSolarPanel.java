...
public class GuiAdvSolarPanel extends GuiContainer {
    ...
    protected void drawGuiContainerForegroundLayer(int par1, int par2) {
        ...
        this.fontRendererObj.drawString(formatPanelName, nmPos, 5, 7718655);
        ...
        this.fontRendererObj.drawString(maxOutputString +  GuiNumberUtils.getString(a[1]) + " " + energyPerTickString, 50-4, 26+6, 13487565);
        if (output_dob != 0)
            this.fontRendererObj.drawString(ModulesString3 + (output_dob) + "%", 15-4, 175-2, 13487565);
        ...
        this.fontRendererObj.drawString(generatingString + generation + " " + energyPerTickString, 50-4, 36+4, 13487565);
        ...
        if (tierplus != 0 && tierplus - minus > 0 && this.tileentity.o > 0) {
            this.fontRendererObj.drawString(tierString + this.tileentity.o, 50-4, 46+2, 13487565);
            ...
            this.fontRendererObj.drawString(tierString + Character.MIN_VALUE, 50-4, 46+2, 13487565);
        } else {
            this.fontRendererObj.drawString(tierString + Character.MIN_VALUE, 50-4, 46+2, 13487565);
        }
    }
    ...
    protected void drawGuiContainerBackgroundLayer(float f, int i, int j) {
        ...
        if (this.tileentity.storage > 0 || this.tileentity.storage <= this.tileentity.maxStorage) {
            ...
            drawTexturedModalRect(h + 18-6, k + 24, 194, 0, (int)(l + 1.0F), 14);
        }
        if (this.tileentity.storage2 > 0 || this.tileentity.storage2 <= this.tileentity.maxStorage2) {
            ...
            drawTexturedModalRect(h + 19+72+40+23+1+2, k + 24, 219, 0, (int)(l), 14);
        }
        if (this.tileentity.skyIsVisible && this.tileentity.solarType != 3 && this.tileentity.solarType != 4) {
            if(this.tileentity.rain == false) {
                if (this.tileentity.sunIsUp) {
                    drawTexturedModalRect(h + 20, k + 42, 195, 15, 14, 14);
                } else if (!this.tileentity.sunIsUp) {
                    drawTexturedModalRect(h + 20, k + 42, 210, 15, 14, 14);
                }
            } else {
                if (this.tileentity.sunIsUp) {
                    drawTexturedModalRect(h + 20, k + 42, 225, 15, 14, 14);
                } else if (!this.tileentity.sunIsUp) {
                    drawTexturedModalRect(h + 20, k + 42, 240, 15, 14, 14);
                }
            }
        }
