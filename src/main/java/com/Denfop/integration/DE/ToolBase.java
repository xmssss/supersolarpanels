...
public class ToolBase extends RFItemBase {
  ...
  private static final Set PICKAXE_OVERRIDES = Sets.newHashSet(new Object[] { 
        Blocks.cobblestone, Blocks.double_stone_slab, Blocks.stone_slab, Blocks.stone, Blocks.sandstone, Blocks.mossy_cobblestone, Blocks.iron_ore, Blocks.iron_block, Blocks.coal_ore, Blocks.gold_block, 
  ...
  private static final Set AXE_OVERRIDES = Sets.newHashSet(new Object[] { 
        Blocks.planks, Blocks.bookshelf, Blocks.log, Blocks.log2, Blocks.chest, Blocks.pumpkin, Blocks.lit_pumpkin, Material.wood, Material.leaves, Material.coral, 
