...
public class CTAlloySmelter {
	...
	private static class AddAlloSmelterIngredientAction extends OneWayAction {
		...
		public void apply() {
			Recipes.Alloysmelter.addRecipe((IRecipeInput) new IC2RecipeInput(this.container),
					(IRecipeInput) new IC2RecipeInput(this.fill),

					MineTweakerMC.getItemStack(this.output));
			Recipes.Alloysmelter.addRecipe((IRecipeInput) new IC2RecipeInput(this.fill),
					(IRecipeInput) new IC2RecipeInput(this.container),
		...
		public boolean equals(Object obj) {
			...
			if (this.container != other.container
					&& (this.container == null || !this.container.equals(other.container)))
				return false;
