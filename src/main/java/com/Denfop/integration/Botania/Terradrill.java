...
public class Terradrill extends ItemTool implements IElectricItem {
	public static final Set<Block> mineableBlocks = Sets
			.newHashSet(new Block[] { (Block) Blocks.grass, Blocks.dirt, (Block) Blocks.mycelium, (Block) Blocks.sand,
					Blocks.gravel, Blocks.snow, Blocks.snow_layer, Blocks.clay, Blocks.soul_sand });

	private static final Set<Material> materials = Sets.newHashSet(
			new Material[] { Material.rock, Material.grass, Material.ground, Material.sand, Material.clay });
