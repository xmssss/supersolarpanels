...
public class BotaniaIntegration {
	...
	public static void init() {
		GameRegistry.registerBlock(blockBotSolarPanel = (Block)new blockBotSolarPanel(), (Class)ItemBotSolarPanel.class, "blockBotSolarPanel");
		 GameRegistry.registerItem( manasteel_plate = new SSPItemBase().setMaxStackSize(64).setUnlocalizedName("manasteel_plate").setTextureName("supersolarpanel:manasteel_plate"),"manasteel_plate");    
		 GameRegistry.registerItem( manasteel_core = new SSPItemBase().setMaxStackSize(64).setUnlocalizedName("manasteel_core").setTextureName("supersolarpanel:manasteel_core"),"manasteel_core");    
		 GameRegistry.registerItem( elementium_plate = new SSPItemBase().setMaxStackSize(64).setUnlocalizedName("elementium_plate").setTextureName("supersolarpanel:elementium_plate"),"elementium_plate");    
		 GameRegistry.registerItem( elementium_core = new SSPItemBase().setMaxStackSize(64).setUnlocalizedName("elementium_core").setTextureName("supersolarpanel:elementium_core"),"elementium_core");    
		 GameRegistry.registerItem( terrasteel_plate = new SSPItemBase().setMaxStackSize(64).setUnlocalizedName("terrasteel_plate").setTextureName("supersolarpanel:terrasteel_plate"),"terrasteel_plate");    
		 GameRegistry.registerItem( terrasteel_core = new SSPItemBase().setMaxStackSize(64).setUnlocalizedName("terrasteel_core").setTextureName("supersolarpanel:terrasteel_core"),"terrasteel_core");    
		 GameRegistry.registerItem( rune_sun = new SSPItemBase().setMaxStackSize(64).setUnlocalizedName("rune_sun").setTextureName("supersolarpanel:rune_sun"),"rune_sun");    
		 GameRegistry.registerItem( rune_night = new SSPItemBase().setMaxStackSize(64).setUnlocalizedName("rune_night").setTextureName("supersolarpanel:rune_night"),"rune_night");    
		 GameRegistry.registerItem( rune_energy = new SSPItemBase().setMaxStackSize(64).setUnlocalizedName("rune_energy").setTextureName("supersolarpanel:rune_energy"),"rune_energy");    
	...
	public static void recipe() {
		BotaniaAPI.registerRuneAltarRecipe(new ItemStack(rune_energy, 1, 0), 12000, new Object[] { LibOreDict.RUNE[0], LibOreDict.RUNE[1],  new ItemStack(SSPItem.photoniy) , new ItemStack( SSPItem.itemSSP ,1,0), new ItemStack( SSPItem.itemSSP ,1,7), new ItemStack(elementium_plate ) ,new ItemStack(SSPItem.compresscarbonultra )});
		BotaniaAPI.registerRuneAltarRecipe(new ItemStack(rune_sun, 1, 0), 12000, new Object[] { LibOreDict.RUNE[4], LibOreDict.RUNE[3],  new ItemStack(SSPItem.photoniy_ingot) , new ItemStack( SSPItem.itemSSP ,1,0), new ItemStack( SSPItem.itemSSP ,1,7), new ItemStack(elementium_plate ) ,new ItemStack(SSPItem.compresscarbon )});
		BotaniaAPI.registerRuneAltarRecipe(new ItemStack(rune_night, 1, 0), 12000, new Object[] { LibOreDict.RUNE[7], LibOreDict.RUNE[5],  new ItemStack(SSPItem.dust) , new ItemStack( SSPItem.itemSSP ,1,0), new ItemStack( SSPItem.itemSSP ,1,7), new ItemStack(manasteel_plate ) ,new ItemStack(SSPItem.coal_chunk1 )});
		 ...
		 GameRegistry.addRecipe(new ItemStack(teraDDrill,1,OreDictionary.WILDCARD_VALUE), new Object[] { " L ", "ODO", "COC",  'O',  SSPItem.overclockerUpgrade, 'D' , new ItemStack(Ic2Items.diamondDrill.getItem(),1,OreDictionary.WILDCARD_VALUE), 'C' ,terrasteel_plate,'L',ModItems.terraPick});
		 GameRegistry.addRecipe(new ItemStack(terrasteel_core), new Object[] { "KLM", "DOD", "CHC",  'C',  terrasteel_plate, 'D' ,SSPItem.itemIrradiantGlassPane, 'O' ,terrasteel_plate,'L',IC2Items.getItem("advancedAlloy"),'K',rune_night,'M',rune_sun,'H',rune_energy});
		 GameRegistry.addRecipe(new ItemStack(elementium_core), new Object[] { "KLM", "DOD", "CHC",  'C',  elementium_plate, 'D' ,SSPItem.photoniy_ingot, 'O' ,manasteel_core,'L',IC2Items.getItem("advancedCircuit"),'K',rune_night,'M',rune_sun,'H',rune_energy});
		 GameRegistry.addRecipe(new ItemStack(manasteel_core), new Object[] { "KLM", "DOD", "CHC",  'C',  manasteel_plate, 'D' ,SSPItem.photoniy_ingot, 'O' ,SSPItem.advanced_core ,'L',IC2Items.getItem("advancedCircuit"),'K',rune_night,'M',rune_sun,'H',rune_energy});
		 GameRegistry.addRecipe(new ItemStack(blockBotSolarPanel, 1, 0), new Object[] { "BBB", "BAB", "BBB", 'A',  manasteel_core, 'B' , new ItemStack(SSPItem.blockSSPSolarPanel, 1, 0)}); 
