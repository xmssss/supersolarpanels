...
public class WailaHandler implements IWailaDataProvider {
    ...
    public List<String> getWailaBody(ItemStack itemStack, List<String> currenttip, IWailaDataAccessor accessor, IWailaConfigHandler config) {
        ...
        if(accessor.getWorld().getTileEntity(accessor.getPosition().blockX, accessor.getPosition().blockY,accessor.getPosition().blockZ) instanceof TileEntitySolarPanel) {
            ...
            currenttip.add(StatCollector.translateToLocal("gui.AdvancedSolarPanel.generating") +" "+ generating+" EU/t" + EnumChatFormatting.RESET);
            currenttip.add(StatCollector.translateToLocal("gui.AdvancedSolarPanel.maxOutput") +" "+ production+" EU/t" + EnumChatFormatting.RESET);
