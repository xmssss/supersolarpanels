	...
	public void addInformation(ItemStack stack, EntityPlayer player, List list, boolean par4) {
		...
		case Overclocker1:
			list.add(StatCollector.translateToLocalFormatted("ic2.tooltip.upgrade.overclocker.time",
					new Object[] { decimalformat.format(100.0D
							* Math.pow(getProcessTimeMultiplier(stack, (IUpgradableBlock) null), stack.stackSize)) }));
			list.add(StatCollector.translateToLocalFormatted("ic2.tooltip.upgrade.overclocker.power",
					new Object[] { decimalformat.format(100.0D
							* Math.pow(getEnergyDemandMultiplier(stack, (IUpgradableBlock) null), stack.stackSize)) }));
			break;
		case Overclocker2:
			list.add(StatCollector.translateToLocalFormatted("ic2.tooltip.upgrade.overclocker.time",
					new Object[] { decimalformat.format(100.0D
