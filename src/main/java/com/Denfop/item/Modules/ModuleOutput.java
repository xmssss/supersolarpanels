...
public class ModuleOutput extends Item implements IModulOutput {
	public ModuleOutput() {
	...
	public void addInformation(ItemStack itemStack, EntityPlayer player, List info, boolean b) {
		info.add(StatCollector.translateToLocal("ssp.module4") + " " + IModulOutput.getData(itemStack).get(0) + "% "
