...
public class EnergyPickaxe extends ItemTool implements IElectricItem {
  ...
  private static final Set<String> toolType = (Set<String>)ImmutableSet.of("pickaxe");
...
public int lucky;
  ...
  public boolean canHarvestBlock(Block block, ItemStack stack) {
    return (Items.diamond_pickaxe.canHarvestBlock(block, stack) || Items.diamond_pickaxe.func_150893_a(stack, block) > 1.0F  || mineableBlocks.contains(block));
  }
