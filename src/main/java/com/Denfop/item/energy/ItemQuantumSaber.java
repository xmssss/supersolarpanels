...
public class ItemQuantumSaber extends ItemTool implements IElectricItem, IBoxable, IItemHudInfo {
	...
	public ItemQuantumSaber(String name, int operationEnergyCost, HarvestLevel harvestLevel, int maxCharge,
	...
	public void registerIcons(IIconRegister iconRegister) {
		...
		this.textures[0] = iconRegister
				.registerIcon(Constants.TEXTURES + ":" + getUnlocalizedName().substring(4) + "." + "off");
		this.textures[1] = iconRegister
				.registerIcon(Constants.TEXTURES + ":" + getUnlocalizedName().substring(4) + "." + "active");
	}
	...
	protected enum HarvestLevel {
		Wood(0, Item.ToolMaterial.WOOD), Stone(1, Item.ToolMaterial.STONE), Iron(2, Item.ToolMaterial.IRON),
		Diamond(3, Item.ToolMaterial.EMERALD), Iridium(100, Item.ToolMaterial.EMERALD);
	...
	protected enum ToolClass {
		...
		Shears("shears",
				new Object[] { Blocks.web, Blocks.wool, Blocks.redstone_wire, Blocks.tripwire, Material.leaves }),
		Shovel("shovel", new Object[] { Blocks.snow_layer, Blocks.snow }), Sword("sword", new Object[] { Blocks.web,
