...
public class BasicRecipe {
  public static void recipe() {
   ...
   //TODO craft lenses
    ...
    GameRegistry.addRecipe(new ItemStack(SSPItem.module8,1,2), "CBD", " A ", "DBC", 'A', new ItemStack(SSPItem.module8,1,1), 'B', new ItemStack(SSPItem.QuantumItems,1),'C', new ItemStack(SSPItem.photoniy,1),'D', new ItemStack(SSPItem.advanced_core,1));
